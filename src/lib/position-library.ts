...
export const POSITIONS: Position[] = [
  ...
  { id: "p20", name: "Solo, supine, vibrator + reverse-kegel breath",    category: "solo",      lumbarLoad: 1, hipFlexion: 2, breathAccess: 5, partnerMobility: 1, councilNote: "Paired with diaphragmatic breath. The protocol that re-pairs arousal with breath, not bracing." },
  { id: "p21", name: "Solo, side-lying, dilator + breath",               category: "solo",      lumbarLoad: 1, hipFlexion: 3, breathAccess: 5, partnerMobility: 1, councilNote: "Dilator work is clinician-prescribed. If the council referred you to this, the cadence is in your in-clinic plan." },
