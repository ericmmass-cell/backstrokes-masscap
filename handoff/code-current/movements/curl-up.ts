...
const CURLED: SubjectPose = {
  ...RESTING,
  spineLumbar: [0, 0, 0], // neutral lordosis stays unchanged
  spineThoracic: [deg(12), 0, 0], // upper thorax lifts as a unit
  spineCervical: [deg(4), 0, 0], // neck stays long; no chin-to-chest curl
  head: [deg(4), 0, 0],
};
